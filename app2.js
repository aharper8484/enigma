...
function subsituteLetters(inputIndex, subArray) {}

function rotateLetters(count, direction) {}
...
function encrypt() {
  ...
  for (let i = 0; i < userInput.length; i++) {
    ...
    let userInputIndex = alphabet.indexOf(userInput[i]);
    let plugboardOutput = plugboard[userInputIndex];
    ...
    let fastRotorState = (fastRotor.offset + fastRotor.count) % 26;
